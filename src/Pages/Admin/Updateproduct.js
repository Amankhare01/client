...
const Updateproduct = () => {
    ...
    const getsingleproduct =async()=>{
        try{
            const {data} = await axios.get(`https://mernstackecommerce-production.up.railway.app/api/v1/product/get-product/${params.slug}`);
    ...
    const handleupdate = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.put(`https://mernstackecommerce-production.up.railway.app/api/v1/product/update-product/${id}`,productdata);
            if (data.success) {
    ...
    const handledelete=async()=>{
        try{
            ...
            if (!answer) return;
            const {data} = await axios.delete(`https://mernstackecommerce-production.up.railway.app/api/v1/product/del-product/${id}`);
            toast.success(data.message)
                ...
                <div className="row">
                    ...
                    <div className='m-1 w-75'>
                        ...
                        <div className="mb-3">
                            ...
                            <img src={`https://mernstackecommerce-production.up.railway.app/api/v1/product/photo-category/${id}`} alt={'p.name'} height={"200px"} className='img img-responsiv' />
                        </div>)}
                        </div>
                        <div className="mb-3">
